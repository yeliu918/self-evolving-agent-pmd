/* =============================================================================
 * app.js — MemCurator interactive demo. Dependency-free. Data lives in data.js.
 * ========================================================================== */
"use strict";
...
function buildHero() {
  $("#hero-stat").innerHTML =
    `<div class="hs-head">MemCurator vs. the best write-time baseline · frozen <b>Qwen3-8B</b></div>
     <div class="hs-rows">
...
const FAMILY = {
  ...
  "ours-base": { label: "MemCurator · frozen curator (ours)", css: "ours-base" },
  ours:        { label: "MemCurator · RL-trained (ours)", css: "ours" },
};
